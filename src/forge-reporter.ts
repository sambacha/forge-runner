...
export class ForgeGithubActionsReporter {
  ...
  // Log a message to GitHub Actions or custom handler
  private log(message: string): void {
    if (this.outputHandler) {
      this.outputHandler.log(message);
    } else {
      core.info(message);
    }
  }

  // Start a collapsible group in GitHub Actions or custom handler
  private startGroup(title: string): void {
    if (this.outputHandler) {
      this.outputHandler.startGroup(title);
    } else {
      core.startGroup(title);
    }
  }

  // End a collapsible group in GitHub Actions or custom handler
  private endGroup(): void {
    if (this.outputHandler) {
      this.outputHandler.endGroup();
    } else {
      core.endGroup();
    }
  }
